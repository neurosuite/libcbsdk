...
public:
    ...
    cbSdkResult SdkGetSampleGroupList(UINT32 proc, UINT32 group, UINT32 *length, UINT16 *list);
...
private:
    ...
    struct ContinuousData
    {
        ...
        UINT32 read_end_index[cbNUM_ANALOG_CHANS];              // index location that reading will end.  set in InitTrialData and used in GetTrialData
